...
<template>
  ...
  >
    ...
    <div class="flex items-center pr-10">
      ...
      <img 
        ...
        src="https://yt3.ggpht.com/ytc/AIdro_noxU5k3-tLjaTfm68GSvd8Op8j4sqx_Q9seMpl2BBkyldYmOufH2klOLUIDlWQwmQc7Q=s88-c-k-c0x00ffffff-no-rj"
      >
    </div>
  </div>
  ...
  >
    ...
    <div class="text-[#A2A2AD] font-light text-[12px] pl-[62px] mt-[25px]">
      <div class="py-[9px] hover:text-[#EF5465] cursor-pointer">Favourite Track</div>
