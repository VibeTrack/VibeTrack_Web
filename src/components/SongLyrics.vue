<template>
    <div
        ...
        <div class="w-1/2 max-w-[400px] mx-auto relative flex items-center">
            <div class="absolute z-20 font-bold rounded-xl text-white text-[20px] py-1.5 px-3 m-1">{{ currentArtist.name
                }}</div>
        ...
        <div id="LyricsDiv"
            ...
            <div class="my-[90%]"></div>
            <div class="text-center text-[40px] font-semibold opacity-100" v-for="res in lyrics[currentTrack.id]"
                :key="res" :class="snapToPosition(res)" v-show="res">
