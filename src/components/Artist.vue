<template>
  <div>
    <div class="flex justify-between pb-5 ml-8 mr-6">
      <RouterLink to="/artist" @mouseenter="isHoverArtist = true" @mouseleave="isHoverArtist = false"
        :class="isHoverArtist ? 'hover:text-[#EF5465]' : 'text-white'"
        class="flex items-center font-semibold text-xl cursor-pointer">
        {{ Artist }}
        <ChevronRight :fillColor="isHoverArtist ? '#EF5465' : '#FFFFFF'" :size="25" class="mt-1" />
      </RouterLink>
